...
use yorkie_eval::NnueError;
use yorkie_state::{Move, Position, SfenBuf, SfenError, TextWriter, UsiMoveBuf};

/// A load failure's message as an owned string.
pub fn nnue_error_message(err: &NnueError) -> String {
